...
| `unsupported_mime` | File type not in the allowed list. The `detected` field shows what was sniffed. Pingo accepts text/source code (stored as `text/plain`) and common images (jpeg/png/webp/gif/svg/ico). |
